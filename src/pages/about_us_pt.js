          ...
          <div className="container-fluid dual right">
            ...
            <div className="text_wrapper">
              <div>
                <h2>A Competição</h2>
                <p>
                  Formula Student é uma competição entre estudantes de
                  engenharia que ocorre anualmente em diversos países. Equipas
                  de estudantes de todo o mundo projetam, constroem e testam um
                  carro de competição monolugar. Os veículos são avaliados com
                  base em múltiplos critérios. Existem eventos dinâmicos e
                  estáticos, cada um destes eventos avalia uma ou mais
                  caracteristicas do veículo como endurance, cost e design de
                  engenharia.
                </p>
              </div>
            </div>
          ...
          <div className="container-fluid dual left">
            <div className="text_wrapper">
              <div>
                <h2>O Projeto</h2>
                <p>
                  Este projeto, para além de melhorar as capacidades de
          ...
          <div className="container-fluid">
            <div className="text_wrapper">
              ...
              <p>
                ...
                composta apenas por 7 membros, mas tem vindo a crescer.
                Atualmente contamos com cerca de 50 alunos que participam no
                projeto, vindo estes de todos os cursos do ISEL.
              </p>

              <p>
                Em 2013-2014 a equipa começou a projetar o carro IFS01. É um
                veículo a combustão que tem como características principais a
                sua leveza, segurança e simplicidade. A equipa, em 2014,
                participou na competição de Silverstone na classe 2, project
                class, onde acabou em terceiro lugar.
              </p>
              ...
              <p>
                Com ambição sempre presente, em 2016-2017 a equipa deu início a
                um novo projeto, o IFS02, o primeiro veículo elétrico da equipa.
                A equipa participou na competição na República Checa, em 2017,
                com o IFS01 evo, com uma melhor performance.
              </p>
              ...
              <p>
                ...
                todas as tarefas necessárias para obter um bom desempenho
                futuro.
              </p>
              <p>
                Na época de 2021-2022 a equipa participou novamente na
                competição Formula Student Spain, em Barcelona, com o IFS03.
              </p>
              <p>
                E em 2022-2023, competiu pela primeira vez, com o seu carro
                IFS03, na competição de FS Áustria no Red Bull Ring, em
                Spielberg e na FS Portugal, no Kartódromo de Castelo Branco.
              </p>
              <p>
                Na presente época, 2023-2024, a equipa começou a desenvolver o
                seu terceiro veículo elétrico, o IFS04, e irá novamente às
                competições FS Spain e FS Portugal, irá apresentar o IFS04 ao
                público com a realização de um rollout.
              </p>
            </div>
          </div>
        </article>
